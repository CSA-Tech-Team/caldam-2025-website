  ...
  return (
    <div className="bg-black p-8 text-white">
      ...
      >
        ...
        <div
          className={`lg:text-right ${path !== "/" && "flex flex-1 justify-between max-lg:flex-col"} 
        ${path === "/call-for-papers" && "mx-[40%] flex  items-center justify-center  "}`}
        >
          <div
      ...
      <div className="text-center">
        ...
        <div className="space-y-2 text-balance ">
          <p>
            <BiCopyright className="inline" /> 2024 - 2025, PSG College of
            Technology
          </p>
          <p>
