...
function Footer() {
    return (
        <div className="p-6 z-50 relative bg-black-500 text-white ">
            <div className=" flex max-lg:flex-col justify-between ">
                <div className=" flex flex-col space-y-5  ">
                    <h1 className=" lg:text-4xl  font-bold max-lg:text-2xl ">
                        Location
                    </h1>
                    <iframe
                        ...
                        allowFullScreen=""
                        className=" lg:w-[500px] lg:h-[500px] max-lg:h-full max-lg:w-full  "
                    ></iframe>
                </div>
                <div className=" flex space-x-4  py-4 lg:flex-col text-lg justify-between">
                    <div className=" flex flex-col items-center ">
                        <h1 className=" font-bold lg:text-3xl max-lg:text-xl ">
                            CONTACT
                        </h1>
