        ...
        <div className="p-2 max-lg:pt-[2%] lg:pt-[9%] xl:pt-[7%] justify-center">
            ...
            <div className="p-10 w-full">
                ...
                <p className=" text-2xl max-lg:text-lg ">
                    CALDAM 2024 invites papers describing original research in
                    the areas of design, analysis and experimental evaluation of
                    algorithms and in discrete applied mathematics. An
                    indicative list of sub-areas are given below. 
                    <span className=" font-bold ">
                        Papers must be typeset using LaTeX/LaTeX2e and may not
                        exceed 12 pages in LNCS style, including bibliographic
                        references
                    </span>
                    . Further details may be included in a clearly marked
                    appendix that will be read at the discretion of the program
                    committee. Only electronic submission is allowed. Submitted
                    papers must describe previously unpublished work and may not
                    be submitted concurrently to another conference with
                    refereed proceedings or to a refereed journal. Please find
                    the guidelines for authors on{" "}
                    <a
                        target="_blank"
                ...
                <p className=" py-2 text-2xl max-lg:text-lg ">
                    As in earlier CALDAMs, the proceedings of accepted papers of
                    CALDAM 2024 will be published in the Lecture Notes in
                    Computer Science by Springer. Also, selected papers of
                    CALDAM 2024 are likely to be published in a special issue of
