...
export default function Eligiblity() {
  return (
    <div className='px-10 py-4 lg:px-16'>
      ...
      <ul className='leading-tight space-y-5 py-5 '>
        {eligiblities.map((eligiblity, i) => {
          return (
            <li
              key={i}
              className="before:content-[' '] text-lg relative pl-6 before:absolute before:left-0 before:top-[5px] before:m-auto before:h-4 before:w-4 before:bg-orange"
            >
