...
export default function Home() {
  return (
    ...
    //   <main
    //     className={
    //       "[height:100%] [min-height:100vh] bg-[url('../public/psg_entrance.png')] bg-no-repeat bg-cover px-10 py-5"
    //     }
    //   >
    //     <nav
    //       className={
    //         "navbar bg-magenta h-20 flex w-full justify-center text-seasalt align-middle items-center font-semibold rounded-full"
    //       }
    //     >
